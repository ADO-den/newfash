// js/women-shoes.js
// JK Fashion Empire - Women's Shoes page interactions
...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    var title = titleEl ? titleEl.textContent.trim() : 'Women shoe';
  ...
  (function setupQuickPreview() {
    function createPreview() {
      ...
      overlay.id = 'shoe-preview-women';
      overlay.style.cssText = 'position:fixed;inset:0;display:none;align-items:center;justify-content:center;background:rgba(0,0,0,0.6);z-index:1200;padding:20px;';
      overlay.innerHTML = '<div style="max-width:900px;width:100%;background:#fff;border-radius:12px;overflow:hidden;position:relative;">' +
        '<button id="shoe-preview-close-women" aria-label="Close" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>' +
        '<img id="shoe-preview-img-women" src="" alt="Preview" style="width:100%;height:420px;object-fit:cover;display:block;" />' +
        '<div style="padding:14px;"><h3 id="shoe-preview-title-women" style="margin:0 0 6px 0;font-weight:800;"></h3><p id="shoe-preview-price-women" style="margin:0;color:#666;font-weight:700;"></p></div>' +
        '</div>';
      document.body.appendChild(overlay);

      overlay.querySelector('#shoe-preview-close-women').addEventListener('click', function () {
    ...
    var overlay = document.getElementById('shoe-preview-women') || createPreview();
    ...
    document.addEventListener('click', function (e) {
      ...
      var previewImg = overlay.querySelector('#shoe-preview-img-women');
      var previewTitle = overlay.querySelector('#shoe-preview-title-women');
      var previewPrice = overlay.querySelector('#shoe-preview-price-women');
